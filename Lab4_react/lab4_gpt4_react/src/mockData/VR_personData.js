import person_in_vr from "../assets/img/person_in_vr.svg";
...
export const text_content_personData = {
...
export const VR_personData = {
    imageData,
    text_content_personData
}

export default VR_personData